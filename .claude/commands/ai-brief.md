...
1. Search my Outlook folder "Claude AI News Recap" for newsletters received in the last 24 hours (newest first). NEVER read the Junk folder. Stay read-only on mail — do not delete, move, or send anything.
